      ...
      <Section>
        <div className="sobremi-container-hijo">
          ...
          <p className="sobremi-texto">
            Soy Julian Lopez. Siempre tuve afinidad y atracción con el mundo de
            la tecnología. Después de terminar la escuela, por meses me sentí
      ...
      <Section>
        <div className="sobremi-container-hijo">
          ...
          <p className="sobremi-texto">
            ...
            trabajo en esta profesión que me apasiona. Me adapto rápido al
            equipo de trabajo, soy empático, social y me gusta conocer más sobre
            mis compañeros y fomentar un buen ambiente. Mi razonamiento
            orientado a la operativización y resolución de problemas me permite
            desgranar la situación para buscar soluciones adecuadas y enfocadas.
            Me gusta mucho aprender y enseñar, a la vez que soy receptivo. Soy
            creyente de que todos tenemos algo que enseñarnos 😉.
          </p>
        </div>
      </Section>
    </section>
